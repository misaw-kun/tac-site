...
function TacHeader({ isHome = false }: { isHome?: boolean }) {
  return (
    <header className="py-10 lg:py-12 w-full relative">
      <div className="hidden md:flex absolute justify-between w-full">
        <Link href="/">
